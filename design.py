...
@app.route('/home')
def home():
    return render_template('design1.html', current_user=current_user)
...
@app.route('/store')
def store():
    return render_template('storedesign.html', current_user=current_user)

@app.route('/Sports')
def sports():
    return render_template('Sports.html', current_user=current_user)

@app.route('/Beauty')
def beautiful():
    return render_template('Beauty.html', current_user=current_user)

@app.route('/Clothing')
def clothing():
    return render_template('Clothing.html', current_user=current_user)

@app.route('/Electronics')
def electronics():
    return render_template('Electronics.html', current_user=current_user)

@app.route('/homekitchen')
def homekit():
    return render_template('HomeandKit.html', current_user=current_user)
